...
users = {
    ...
    'diana': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'muflih': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'titus': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'arumugham': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'srijesh': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'radstar': {'password': generate_password_hash('1234'), 'role': 'admin'},
    'drsuneel': {'password': generate_password_hash('1234'), 'role': 'doctor'},
    'drsanketa': {'password': generate_password_hash('1234'), 'role': 'doctor'},
